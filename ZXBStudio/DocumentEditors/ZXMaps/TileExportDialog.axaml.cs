...
{
    public partial class TileExportDialog : Window
    {
        ...
        public bool Initialize(string fileName, IEnumerable<ZXMapsTile> tilesData)
        {
            ...
            {
                exportConfig = ServiceLayer.Export_Tile_GetDefaultConfig(fileName);
            }

            this.cmbSelectExportType.Initialize(ExportType_Changed);
            cmbSelectExportType.InitializeTile();
        ...
        private void Refresh()
        {
            ...
            if (tiles == null || tiles.Where(d => d != null && d.Export).Count() == 0)
            {
        ...
        private void CreateExample_PutChars()
        {
            ...
            var res = ExportManager.Export_Tiles_PutChars(exportConfig, tiles);
        ...
        private void Export()
        {
            ...
            em.Initialize(FileTypes.Tile);
            em.ExportTiles(exportConfig, tiles);
        }
        ...
        private async void BtnOutputFile_Tapped(object? sender, Avalonia.Input.TappedEventArgs e)
        {
            ...
            fileTypes[0] = new FilePickerFileType("Tile files") { Patterns = new[] { "*.zxtiledata" } };
